...
-- 4. Все исполнители, которые не выпустили альбомы в 2020 году
    ...
    SELECT art_1.first_name || ' ' || art_1.second_name "Имя, фамилия",
           art_1.alias "Псевдоним/группа", release_year
 ...
 --    Пусть это будет "НА-НА"
    ...
    SELECT c_1.title "Название сборника"
      ...
      JOIN collections_tracks AS c_t
        ON c_1.collection_id AS c_t
      JOIN track AS t_1
        ON c_t.track_id AS c_t_1
      JOIN album AS a_1
        ON t_1.album_id AS t_a_1
      JOIN albums_artists AS a_a
        ON a_a.album_id AS a_a.albumid
      JOIN art_1.first_name || ' ' || art_1.second_name "Имя, фамилия",
           art_1.alias "Псевдоним/группа" AS art_1
        ON a_a.artist_id AS art.artistid
     	WHERE art_1.alias = 'НА-НА')

 -- 6. Названия альбомов, в которых присутствуют исполнители более 1 жанра


SELECT Album.Title FROM album_artist
